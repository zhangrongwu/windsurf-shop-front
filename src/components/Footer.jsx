...
const navigation = {
  shop: [
    { name: 'Boards', href: '/products?category=Boards' },
    { name: 'Sails', href: '/products?category=Sails' },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Your premier destination for high-quality windsurfing gear and equipment.
            </p>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} WindsurfShop. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
